...
export const LANG_PROMPT_TA =
  "விவசாயிகள் கொள்முதல் உதவி மையத்திற்கு வரவேற்கிறோம். " +
  "தமிழில் தொடர, ஒன்று என்பதை அழுத்தவும். " +
  "ஆங்கிலத்தில் தொடர, இரண்டு என்பதை அழுத்தவும். " +
  "இந்தியில் தொடர, மூன்று என்பதை அழுத்தவும்.";
...
export const P = {
  ...
  ta: {
    code: "ta-IN",
    idEnter: "தயவுசெய்து உங்கள் ஆறு இலக்க விவசாயி அடையாள எண்ணை உள்ளிடவும். பின்னர் ஹாஷ் பொத்தானை அழுத்தவும்.",
    idInvalid: "மன்னிக்கவும். இந்த விவசாயி அடையாள எண் கிடைக்கவில்லை. எண்ணை சரிபார்த்து மீண்டும் முயற்சிக்கவும்.",
    idConfirm: (n) => `உங்கள் விவசாயி அடையாள எண் ${tamilFarmerName(n)} அவர்களின் பெயரில் உள்ளது. உறுதிப்படுத்த ஒன்று என்பதை அழுத்தவும். மீண்டும் உள்ளிட இரண்டு என்பதை அழுத்தவும்.`,
    mainMenu: "முதன்மை மெனு. கொள்முதல் நேரத்தை முன்பதிவு செய்ய ஒன்று என்பதை அழுத்தவும். உங்கள் தற்போதைய முன்பதிவு விவரங்களை கேட்க இரண்டு என்பதை அழுத்தவும். நேரடி வரிசை நிலையை அறிய மூன்று என்பதை அழுத்தவும். முந்தைய மெனுவிற்கு செல்ல ஒன்பது என்பதை அழுத்தவும்.",
    locList: (list) =>
      "உங்களுக்கு அருகிலுள்ள கொள்முதல் மையங்கள். " +
      list.map((l, i) => `${taNumber(i + 1)} என்பதை அழுத்தினால் ${taLocation(l.name)}. இது உங்களிடமிருந்து ${tamilKm(l.km)} தொலைவில் உள்ளது.`).join(" ") +
      " முதன்மை மெனுவிற்கு செல்ல ஒன்பது என்பதை அழுத்தவும்.",
    booked: (b) => `உங்கள் கொள்முதல் நேர முன்பதிவு வெற்றிகரமாக முடிந்தது. உங்கள் டோக்கன் எண் ${b.token}. தேதி ${tamilDate(b.date)}. நேரம் ${tamilTime(b.time)}. கொள்முதல் மையம் ${taLocation(b.location_name)}. தயவுசெய்து குறிப்பிட்ட நேரத்திற்கு முன்பாக மையத்திற்கு வரவும்.`,
    noBooking: "உங்களிடம் தற்போது செயலில் உள்ள முன்பதிவு எதுவும் இல்லை. முன்பதிவு செய்ய ஒன்று என்பதை அழுத்தவும். முதன்மை மெனுவிற்கு செல்ல ஒன்பது என்பதை அழுத்தவும்.",
    preview: (b) => `உங்கள் டோக்கன் எண் ${b.token}. தேதி ${tamilDate(b.date)}. நேரம் ${tamilTime(b.time)}. கொள்முதல் மையம் ${taLocation(b.location_name)}.`,
    queue: (q, name) => `${taLocation(name)} மையத்தில், உங்களுக்கு முன்னால் ${q.people_ahead} விவசாயிகள் உள்ளனர். காத்திருக்கும் நேரம் சுமார் ${q.eta_minutes} நிமிடங்கள். முதன்மை மெனுவிற்கு செல்ல ஒன்பது என்பதை அழுத்தவும்.`,
    goodbye: "விவசாயிகள் கொள்முதல் உதவி மையத்தை தொடர்பு கொண்டதற்கு நன்றி. உங்கள் அழைப்பு முடிக்கப்பட்டது. வணக்கம்.",
    invalidKey: "தவறான தேர்வு. தயவுசெய்து சரியான எண்ணை அழுத்தவும்.",
    retry: "மீண்டும் முயற்சிப்போம்.",
    timeout: "உங்கள் பதில் கிடைக்கவில்லை. தயவுசெய்து மீண்டும் தேர்வு செய்யவும்.",
  },
